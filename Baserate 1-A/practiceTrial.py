...
def testpractice(window, textStudyContains, textPersonIs, textThereAre, textLikelyToBe, run_number, workBook):
    ...
    #first time it runs, shows how to use the left and right keys to select answer
    if run_number == 1:
        frame_tut1 = visual.TextStim(window, text = textTutorial_1, font = 'Arial', units = 'norm', pos = [0, 0.7], height = 0.07, wrapWidth=None)
        frame4 = visual.TextStim(window, text = textLikelyToBe, font = 'Arial', units = 'norm', pos = [0, 0.5], height = 0.07, wrapWidth=None)
        frame4_answer1 = visual.TextStim(window, text = value_dict['Answeroption1'], font = 'Arial', units = 'norm', pos = [0.3, 0], height = 0.07, wrapWidth=None)
        frame4_answer2 = visual.TextStim(window, text = value_dict['Answeroption2'], font = 'Arial', units = 'norm', pos = [-0.3, 0], height = 0.07, wrapWidth=None)
        ...
        frames_list = [frame4, frame4_answer1, frame4_answer2, frame_tut1, frame_tut2]
